Códigos para probar el funcionamiento del micrófono INMP441 (comunicaciones.ino), del amplificador MAX98357A (prueba_amp.ino) y de la placa LILYGO T-A7670G (PruebaLTE.ino). 
